...
export const CommandPalette: React.FC<CommandPaletteProps> = ({
  ...
  const commands: CommandItem[] = useMemo(() => [
    ...
    },
    {
      id: 'nav-maintenance',
      category: 'Pages',
      title: 'Preventive Maintenance & Asset Schedules',
      subtitle: 'Equipment inspection cycles & auto PM tickets',
      icon: <CalendarCheck className="w-4 h-4 text-emerald-600 dark:text-sage-300" />,
    ...
    },
    {
      ...
      category: 'Pages',
      title: 'Customer Live Mobile Portal',
      subtitle: 'Real-time client tracking and digital signature pad',
      icon: <Smartphone className="w-4 h-4 text-sky-600 dark:text-cyan-400" />,
      action: () => { navigate('/customer-portal'); onClose(); },
      badge: 'New',
    },
    {
      id: 'nav-audit',
      category: 'Pages',
      title: 'Regulatory Audit Trail & Log',
      subtitle: 'Chronological immutable event ledger and compliance log',
