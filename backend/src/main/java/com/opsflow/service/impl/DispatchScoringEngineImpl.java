...
import com.opsflow.dto.dispatch.ScoreBreakdownDto;
...
public class DispatchScoringEngineImpl implements DispatchScoringEngine {
    ...
    public DispatchScoringEngineImpl(
            @Value("${opsflow.dispatch.weight-skill:0.35}") double weightSkill,
            @Value("${opsflow.dispatch.weight-distance:0.25}") double weightDistance,
            @Value("${opsflow.dispatch.weight-workload:0.20}") double weightWorkload,
            @Value("${opsflow.dispatch.weight-sla:0.20}") double weightSla) {
