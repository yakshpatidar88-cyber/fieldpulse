...
public class DispatchWorkflowIntegrationTest extends OpsFlowContainerBaseTest {
    ...
    private String obtainDispatcherJwtToken() throws Exception {
        LoginRequestDto loginRequest = new LoginRequestDto("dispatcher.sarah@opsflow.io", "password123");
    ...
    void testPublicHealthEndpoint() throws Exception {
        mockMvc.perform(get("/health"))
                ...
                .andExpect(jsonPath("$.service").value("opsflow-backend"));
    }
    ...
    void testDispatcherAuthenticationFlow() throws Exception {
        ...
        mockMvc.perform(post("/auth/login")
                ...
                .andExpect(jsonPath("$.data.email").value("dispatcher.sarah@opsflow.io"))
