...
class DispatchServiceTest {
    ...
    private Technician createTestTechnician(Long id, String code) {
        ...
        User user = new User();
        user.setEmail(code.toLowerCase() + "@fieldpulse.io");
