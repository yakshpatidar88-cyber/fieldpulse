...
@ActiveProfiles("test")
public class FieldPulseContainerBaseTest {

    @Container
    protected static final PostgreSQLContainer<?> postgres = new PostgreSQLContainer<>("postgres:16-alpine")
            .withDatabaseName("FieldPulse_test")
            .withUsername("FieldPulse_test")
    ...
    void contextLoads() {
        assertTrue(true, "FieldPulse context loads successfully");
    }
}
